    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        QuantityNeeded = c.Int(nullable: false),
                        QuantityReturned = c.Int(nullable: false),
                        IsMissingItems = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        FinishCode = c.String(),
                        TeamId = c.Int(),
                        IsTeamAssigned = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Events", t => t.EventId, cascadeDelete: true)
                ...
                c => new
                    {
                        ...
                        findRecord = c.Int(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        InspectionDetails_InspectionDetailsId = c.Int(),
                    })
                ...
                .ForeignKey("dbo.InspectionDetails", t => t.InspectionDetails_InspectionDetailsId)
                .Index(t => t.DriverAssignmentId)
                .Index(t => t.EventInventoryId)
                .Index(t => t.InspectionDetails_InspectionDetailsId);
